...
class TestAircraft(unittest.TestCase):
    ...
    def test_aircraft_bounces_at_the_territory_north_border(self):
    ...
    def test_aircraft_bounces_at_the_territory_south_border(self):
    ...
    def test_aircraft_bounces_at_the_territory_east_border(self):
    ...
    def test_aircraft_bounces_at_the_territory_west_border(self):
        territory = Territory(max_longitude=1, max_latitude=0)
